...
int const hvDigitalIn = 19; // pf6 -> A1   D19
int const hvClock = 18;     // pf7 -> A0   D18
...
void setup() {
 ...
 // pinModeFast(hvDigitalIn, OUTPUT);
//  pinModeFast(hvClock, OUTPUT);
  DDRF = DDRF | B11000000;
