...
int currVal[] = {1024, 1024, 1024, 1024};



int measureIter = 0;
float currMeasure = 0;
int minMeasure = 10000; // big number
float maxMeasure = 0;
...
//  delay(1000);
    ...
    delay(7);
    measureIter = (measureIter + 1) % activeChannelCount;
    currVal[measureIter] = sense(measureIter);
...
//      minMeasure = 3000;
//    }
//    Serial.println(currVal[measureIter]);
...
//    Serial.println((val / 1024.0) * 3.3 / 3.0);
  ...
  //    delay(blah);
     ...
     //    prevVal[(iter - 2) % prevValSize][0] != 0 && 
         prevVal[(iter - 5) % prevValSize][0] - val > 50) { 
